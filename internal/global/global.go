...
const (
	...
	RemoteURLMainFileTemplate = `https://raw.fastgit.org/tangzixiang/goprojectinit/master/configs/main-file.temp`
	RemoteURLGitIgnore        = `https://raw.fastgit.org/tangzixiang/goprojectinit/master/configs/.gitignore`
